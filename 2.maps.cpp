...
// Usar sintaxis map<key, value> nombre
// La KEY es unica, pero los VALUES pueden estar repetidos.

int main()
{

    // Un Alumno tendra como identificador key = ID (int)
    ...
    map<int, int>::iterator it; // tengo un iterador que apunta a map<int, int>
